        ...
        {showMore && (
          <div className=''>
            <div className='mx-2 my-1 rounded border-4 border-blue-200 bg-gradient-to-r from-slate-100 to-violet-100 '>
              <button onClick={() => { createList }} className='text-l mr-2 py-1 hover:italic w-full text-blue-500 hover:bg-emerald-100'>
              Create List
            </button>
            </div>
            ...
            <ul className='text-l flex flex-col'>
              ...
              {lists.map((list:string) => (
                ...
                >
                  <button className='inline-block h-full w-full text-slate-500 hover:text-slate-700 hover:italic from-violet-100 to-blue-200 hover:bg-gradient-to-r '>
                    {list}
                  </button>
