...
export default function ListOfTerms() {
    ...
    return (
        <div className='md:w-5/6 md:my-5 md:mr-5 md:ml-2 
                        bg-slate-700 rounded-lg border border-slate-400
                        w-auto h-fit mx-5 mb-5 mt-1 pb-1'>
            ...
            <form className='flex flex-col'>
                <>
                    ...
                    <div className='flex flex-col mx-2 my-1 p-1 bg-gray-200 rounded'>
                        ...
                        {/**Lines: Refs & Tags*/}
                        <div className='md:flex md:flex-row flex flex-col rounded p-1 items-baseline'>
                            ...
                            {/**Tags*/}
                            <div className='flex flex-row bg-gray-100 rounded mt-1'>
