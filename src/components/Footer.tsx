...
export default function Footer() {
  return (
    <div>
      {/**<!----footer---> */}
      <footer className='bg-secondary-100 text-center text-sm dark:bg-secondary-600'>
        <div className='bg-secondary-200 px-4 text-center text-secondary-700 dark:bg-secondary-900 dark:text-secondary-200'>
          <button
            ...
            className='px-3 py-1.5 text-center  font-semibold text-slate-600 dark:text-white'
            type='button'
          >
            Terms of Service |
          </button>
          ...
          <div className='relative rounded-lg bg-white shadow dark:bg-gray-700'>
            ...
            <div className='custom-disclaimer space-y-6 p-6 text-sm'>
              ...
              <div className='leading-relaxed text-gray-500 dark:text-gray-400'>
                ...
                <ul className='list-inside list-disc'>
                  <li>
                    ...
                    Disclaimer) refers to SN-Glossary.
                  </li>
                  ...
                  <li>
                    Website refers to SN-Glossary, accessible from
                    https://www.sn-glossary.com
                  </li>
                </ul>
              </div>
              ...
              <p className='leading-relaxed text-gray-500 dark:text-gray-400'>
                ...
                contents on the Service at any time without prior notice. This
                Disclaimer has been created with the help of the TermsFeed
              ...
              <p className='leading-relaxed text-gray-500 dark:text-gray-400'>
                ...
                believes this constitutes a &quot;fair use&quot; of any such
                copyrighted material as provided for in section 107 of the
                United States Copyright law. If You wish to use copyrighted
              ...
              <div className='leading-relaxed text-gray-700 dark:text-gray-800'>
                ...
                <ul className='list-inside list-disc'>
                  <li>
                    ...
                    <span className='text-blue-700'>legal@sn-glossary.com</span>
                  </li>
                  <li>
                    <span className='underline'>By website page</span>:{' '}
                    <Link href='' className='text-blue-700'>
                      https://www.sn-glossary.com/support
                    </Link>
                  </li>
                </ul>
              </div>
