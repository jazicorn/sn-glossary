    ...
    <div>
      ...
      <nav className='custom-nav-background flex h-14 flex-row justify-between px-4 md:basis-1/12'>
        ...
        <div className='place-self-center'>
          ...
          <Link
            href='/'
            className='hidden items-center px-2 py-5 text-gray-700 hover:text-gray-900 md:flex'
          >
        ...
        {/**<!-- login/logout --> */}
        <div className='md:m-full flex flex-row md:basis-1/12 md:justify-end'>
          <Link
            href='/login'
            className='md:w-18 text-grey-900 hover:text-grey-300 place-self-center rounded-md bg-blue-300 p-1 text-center transition duration-300 hover:bg-blue-400 xs:invisible sm:visible md:px-3 md:py-1'
          >
            Login
          </Link>
        </div>
