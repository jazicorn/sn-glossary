    ...
    <div className={`flex h-screen min-h-full flex-col ${inter.className}`}>
      ...
      <footer className='bg-secondary-100 text-center dark:bg-secondary-600'>
        ...
        <div className='bg-secondary-200 p-4 text-center text-secondary-700 dark:bg-secondary-900 dark:text-secondary-200'>
          <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" className="text-slate-600 dark:text-white font-semibold text-sm px-3 py-1.5 text-center" type="button">
            Terms of Service |
          </button>
          © 2023 Copyright:
      ...
      <div id="defaultModal" tab-index="-1" aria-hidden="true" className="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
